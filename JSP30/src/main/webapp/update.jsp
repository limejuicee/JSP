	...
	<body>
		<form method="post" action="update.do" name="frm">
			<table>
				<tr>
					<td>이름</td>
					<td><input type="text" name="nm" value="${mem.getName() }"></td>
				</tr>
				<tr>
					<td>아이디<td>
				...
				<tr>
					<td>비밀번호 변경<td>
					<td><input type="password" name="pwd" value="${mem.pwd }"	></td>
				</tr>
				<tr>
					<td>비밀번호 확인<td>
				...
				<tr>
					<td>입력<td>
					<td>
						<input type="submit" value="정보수정" onclick="upCheck()">
	...
	<script>
		function upCheck() {
			...
			if(document.frm.pwd.value!=document.frm.pwd_check.value) {
				alert("비밀번호 확인이 다릅ㄴ디ㅏ. 다시 입력해 ㅈ세요");
